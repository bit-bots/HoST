...
class LeggedRobot(BaseTask):
    ...
    # _reward_hip_knee_coupling lives in host_ground_prone.py only: the heel-into-the-back
    # limit is a prone problem, supine never gets into that part of the joint space.
